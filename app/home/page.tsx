...
export default function StudentHomePage() {
  ...
  }, [loading, isAuthenticated, isStudent, user, router, mounted])
        ...
        <StudySessionProvider>
          ...
          <div className="min-h-screen relative z-10">
            ...
            <div className="fixed bottom-6 right-6 z-50">
              <Link href="/ai-chat">
                <div className="bg-gradient-to-br from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="hidden sm:block">
                      ...
                      <p className="text-xs opacity-90">Chat avec Aura</p>
                    </div>
