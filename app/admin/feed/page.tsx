...
export default function AdminFeedPage({ role: propRole }: ManagerFeedPageProps = {}) {
  const { t } = useLanguage()
  ...
  useEffect(() => {
    ...
    const roleParam = 'admin' // Always admin for admin feed page
  ...
  const handleEditItem = (itemId: string) => {
    router.push(`/admin/content/edit/${itemId}`)
  }
              ...
              <div className="flex items-center space-x-6">
                ...
                <div>
                  <h1 className="text-4xl font-bold bg-gradient-to-r from-slate-900 via-blue-900 to-purple-900 dark:from-white dark:via-blue-100 dark:to-purple-100 bg-clip-text text-transparent">
                    {t("Feed Administrateur", "Admin Feed")}
                  </h1>
                  <p className="text-slate-600 dark:text-slate-300 mt-2 text-lg">
                    {t("Espace d'administration du contenu de la plateforme", "Platform content administration space")}
                  </p>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Button
                  ...
                  onClick={() => router.push("/admin/analytics/stats")}
                >
                  <BarChart3 className="w-4 h-4 mr-2" />
                ...
                <Button
                  variant="outline"
                  className="border-gray-200 dark:border-gray-700 bg-transparent justify-start text-foreground hover:bg-muted"
                  onClick={() => router.push("/admin/analytics/audience")}
                >
