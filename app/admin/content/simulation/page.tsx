        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="bg-card border-gray-200 dark:border-gray-700 hover:border-muted transition-colors">
            ...
            <CardContent className="space-y-3">
              ...
              <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white" onClick={() => router.push("/admin/content/upload?type=simulation-paper")}>
          ...
          <Card className="bg-card border-gray-200 dark:border-gray-700 hover:border-muted transition-colors">
            ...
            <CardContent className="space-y-3">
              ...
              <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white" onClick={() => router.push("/admin/content/simulation/builder")}>
