...
export default function SeniorManagerLayout({ children }: { children: React.ReactNode }) {
  ...
  const currentManager = {
    name: "Aïcha Benali",
    email: "aicha.benali@tcf-tef.com",
    role: "Senior Manager",
  }
  ...
  const navigationItems = [
    ...
    {
      name: t("Créer Manager", "Create Manager"),
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-800">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">TCF-TEF Senior</span>
            </div>
            <Button
              variant="ghost"
              size="sm"
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    item.current ? "bg-purple-600 text-white" : "text-gray-300 hover:bg-gray-800 hover:text-white",
                  )}
                >
            ...
            <div className="hidden md:block">
              <div className="relative">
                <input
                  ...
                  className="w-96 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                />
              </div>
            </div>
          </div>
