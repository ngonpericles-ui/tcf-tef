...
function ManagerLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  const navigationItems = useMemo(() => [
    ...
    },
    {
      ...
      icon: BookOpen,
      current: pathname?.startsWith("/manager/content") || false,
    ...
    },
    {
      ...
      icon: Video,
      current: pathname?.startsWith("/manager/sessions") || false,
    ...
    },
    {
      ...
      icon: Users,
      current: pathname?.startsWith("/manager/students") || false,
    },
    {
      name: t("manager.nav.feed", "My Feed"),
      href: "/manager/feed",
      icon: Rss,
      current: pathname?.startsWith("/manager/feed") || false,
      show: currentManager?.permissions.createCourses || currentManager?.permissions.createTests,
    },

    {
      ...
      icon: BarChart3,
      current: pathname?.startsWith("/manager/analytics") || false,
    ...
    },
    {
      ...
      icon: UserPlus,
      current: pathname?.startsWith("/manager/create-manager") || false,
    ...
    },
    {
      ...
      icon: Store,
      current: pathname?.startsWith("/manager/marketplace") || false,
    ...
    },
    {
      ...
      icon: Settings,
      current: pathname?.startsWith("/manager/settings") || false,
    },
