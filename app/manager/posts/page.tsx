...
export default function ManagerPostsPage({ role: propRole }: ManagerPostsPageProps = {}) {
  const { t } = useLanguage()
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">{t("Mes Posts", "My Posts")}</h1>
              <p className="text-muted-foreground">{t("Gérez tous vos posts publiés", "Manage all your published posts")}</p>
            </div>
          </div>
