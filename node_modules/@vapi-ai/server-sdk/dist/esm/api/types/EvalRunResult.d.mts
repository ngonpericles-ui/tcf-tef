...
export declare namespace EvalRunResult {
    /**
     * This is the status of the eval run result.
     * The status is only 'pass' or 'fail' for an eval run result.
     * Currently, An eval is considered `pass` only if all the Assistant Judge messages are evaluated to pass.
    ...
    namespace Messages {
        type Item = Vapi.ChatEvalUserMessageMock | Vapi.ChatEvalSystemMessageMock | Vapi.ChatEvalToolResponseMessageMock | Vapi.ChatEvalAssistantMessageMock;
    }
}
