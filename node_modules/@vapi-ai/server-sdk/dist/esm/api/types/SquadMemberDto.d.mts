...
export declare namespace SquadMemberDto {
    type AssistantDestinations = AssistantDestinations.Item[];
    namespace AssistantDestinations {
        type Item = Vapi.TransferDestinationAssistant | Vapi.HandoffDestinationAssistant;
    }
}
