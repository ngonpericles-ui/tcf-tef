 ...
 */
export var PhoneNumberCallEndingHookFilter;
(function (PhoneNumberCallEndingHookFilter) {
    let OneOf;
    (function (OneOf) {
        OneOf.Item = {
    ...
    })(OneOf = PhoneNumberCallEndingHookFilter.OneOf || (PhoneNumberCallEndingHookFilter.OneOf = {}));
})(PhoneNumberCallEndingHookFilter || (PhoneNumberCallEndingHookFilter = {}));
