...
export declare namespace AnalyticsOperation {
     ...
     * This is the columns you want to perform the aggregation operation on.
     */
    type Column = "id" | "cost" | "costBreakdown.llm" | "costBreakdown.stt" | "costBreakdown.tts" | "costBreakdown.vapi" | "costBreakdown.transport" | "costBreakdown.analysisBreakdown.summary" | "costBreakdown.transcriber" | "costBreakdown.ttsCharacters" | "costBreakdown.llmPromptTokens" | "costBreakdown.llmCompletionTokens" | "duration" | "concurrency" | "minutesUsed";
    const Column: {
        readonly Id: "id";
        readonly Cost: "cost";
        ...
        readonly CostBreakdownTransport: "costBreakdown.transport";
        readonly CostBreakdownAnalysisBreakdownSummary: "costBreakdown.analysisBreakdown.summary";
        readonly CostBreakdownTranscriber: "costBreakdown.transcriber";
