...
exports.StructuredOutputs = void 0;
...
class StructuredOutputs {
     ...
     */
    structuredOutputControllerFindAll(request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__structuredOutputControllerFindAll(request, requestOptions));
    }
    __structuredOutputControllerFindAll() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            var _a, _b, _c, _d, _e, _f;
            const { id, name, page, sortOrder, limit, createdAtGt, createdAtLt, createdAtGe, createdAtLe, updatedAtGt, updatedAtLt, updatedAtGe, updatedAtLe, } = request;
            const _queryParams = {};
            if (id !== undefined) {
                _queryParams["id"] = id;
            }
            ...
            const _response = yield ((_d = this._options.fetcher) !== null && _d !== void 0 ? _d : core.fetcher)({
                url: core.url.join((_f = (_e = (yield core.Supplier.get(this._options.baseUrl))) !== null && _e !== void 0 ? _e : (yield core.Supplier.get(this._options.environment))) !== null && _f !== void 0 ? _f : environments.VapiEnvironment.Default, "structured-output"),
                method: "GET",
                headers: _headers,
     ...
     *     })
     */
    structuredOutputControllerCreate(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__structuredOutputControllerCreate(request, requestOptions));
    }
    __structuredOutputControllerCreate(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            let _headers = (0, headers_js_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.VapiEnvironment.Default, "structured-output"),
                method: "POST",
                headers: _headers,
     ...
     */
    structuredOutputControllerFindOne(id, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__structuredOutputControllerFindOne(id, requestOptions));
    }
    __structuredOutputControllerFindOne(id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            let _headers = (0, headers_js_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.VapiEnvironment.Default, `structured-output/${encodeURIComponent(id)}`),
                method: "GET",
                headers: _headers,
                queryParameters: requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams,
                timeoutMs: (requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
     ...
     */
    structuredOutputControllerRemove(id, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__structuredOutputControllerRemove(id, requestOptions));
    }
    __structuredOutputControllerRemove(id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            let _headers = (0, headers_js_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
     ...
     *     })
     */
    structuredOutputControllerUpdate(id, request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__structuredOutputControllerUpdate(id, request, requestOptions));
    }
    __structuredOutputControllerUpdate(id, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            const { schemaOverride } = request, _body = __rest(request, ["schemaOverride"]);
            const _queryParams = {};
...
exports.StructuredOutputs = StructuredOutputs;
