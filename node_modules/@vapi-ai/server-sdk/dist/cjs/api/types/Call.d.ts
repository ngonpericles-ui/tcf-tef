...
export declare namespace Call {
     ...
     * This is the type of call.
     */
    type Type = "inboundPhoneCall" | "outboundPhoneCall" | "webCall" | "vapi.websocketCall";
    const Type: {
    ...
    namespace Costs {
        type Item = Vapi.TransportCost | Vapi.TranscriberCost | Vapi.ModelCost | Vapi.VoiceCost | Vapi.VapiCost | Vapi.VoicemailDetectionCost | Vapi.AnalysisCost | Vapi.KnowledgeBaseCost;
    }
     ...
     * Only relevant for `outboundPhoneCall` and `inboundPhoneCall` type.
     */
    type PhoneCallProvider = "twilio" | "vonage" | "vapi" | "telnyx";
    const PhoneCallProvider: {
     ...
     * Only relevant for `outboundPhoneCall` and `inboundPhoneCall` type.
     */
    type PhoneCallTransport = "sip" | "pstn";
    const PhoneCallTransport: {
        readonly Sip: "sip";
        readonly Pstn: "pstn";
    };
    /**
     * This is the status of the call.
     */
    type Status = "scheduled" | "queued" | "ringing" | "in-progress" | "forwarding" | "ended";
    const Status: {
    ...
    const EndedReason: {
        ...
        readonly ScheduledCallDeleted: "scheduled-call-deleted";
        readonly CallStartErrorVapifaultGetOrg: "call.start.error-vapifault-get-org";
        readonly CallStartErrorVapifaultGetSubscription: "call.start.error-vapifault-get-subscription";
        ...
        readonly CallStartErrorSubscriptionWalletDoesNotExist: "call.start.error-subscription-wallet-does-not-exist";
        readonly CallStartErrorFraudCheckFailed: "call.start.error-fraud-check-failed";
        readonly CallStartErrorSubscriptionFrozen: "call.start.error-subscription-frozen";
        readonly CallStartErrorSubscriptionInsufficientCredits: "call.start.error-subscription-insufficient-credits";
        readonly CallStartErrorSubscriptionUpgradeFailed: "call.start.error-subscription-upgrade-failed";
        readonly CallStartErrorSubscriptionConcurrencyLimitReached: "call.start.error-subscription-concurrency-limit-reached";
        ...
        readonly PipelineErrorInworldVoiceFailed: "pipeline-error-inworld-voice-failed";
        readonly PipelineErrorMinimaxVoiceFailed: "pipeline-error-minimax-voice-failed";
        ...
        readonly CallInProgressErrorVapifaultInworldVoiceFailed: "call.in-progress.error-vapifault-inworld-voice-failed";
        readonly CallInProgressErrorVapifaultMinimaxVoiceFailed: "call.in-progress.error-vapifault-minimax-voice-failed";
        ...
        readonly CallInProgressErrorProviderfaultVapiLlmFailed: "call.in-progress.error-providerfault-vapi-llm-failed";
        ...
        readonly PipelineErrorDeepgramTranscriberApiKeyMissing: "pipeline-error-deepgram-transcriber-api-key-missing";
        ...
        readonly CallInProgressErrorVapifaultWorkerDied: "call.in-progress.error-vapifault-worker-died";
        readonly CallInProgressTwilioCompletedCall: "call.in-progress.twilio-completed-call";
        readonly CallInProgressSipCompletedCall: "call.in-progress.sip-completed-call";
        readonly CallInProgressErrorProviderfaultOpenaiLlmFailed: "call.in-progress.error-providerfault-openai-llm-failed";
        readonly CallInProgressErrorProviderfaultAzureOpenaiLlmFailed: "call.in-progress.error-providerfault-azure-openai-llm-failed";
        readonly CallInProgressErrorProviderfaultGroqLlmFailed: "call.in-progress.error-providerfault-groq-llm-failed";
        readonly CallInProgressErrorProviderfaultGoogleLlmFailed: "call.in-progress.error-providerfault-google-llm-failed";
        readonly CallInProgressErrorProviderfaultXaiLlmFailed: "call.in-progress.error-providerfault-xai-llm-failed";
        readonly CallInProgressErrorProviderfaultMistralLlmFailed: "call.in-progress.error-providerfault-mistral-llm-failed";
        readonly CallInProgressErrorProviderfaultInflectionAiLlmFailed: "call.in-progress.error-providerfault-inflection-ai-llm-failed";
        readonly CallInProgressErrorProviderfaultCerebrasLlmFailed: "call.in-progress.error-providerfault-cerebras-llm-failed";
        readonly CallInProgressErrorProviderfaultDeepSeekLlmFailed: "call.in-progress.error-providerfault-deep-seek-llm-failed";
        readonly CallInProgressErrorVapifaultChatPipelineFailedToStart: "call.in-progress.error-vapifault-chat-pipeline-failed-to-start";
        ...
        readonly CallInProgressErrorProviderfaultAnthropicLlmFailed: "call.in-progress.error-providerfault-anthropic-llm-failed";
        ...
        readonly CallInProgressErrorProviderfaultAnthropicBedrockLlmFailed: "call.in-progress.error-providerfault-anthropic-bedrock-llm-failed";
        ...
        readonly CallInProgressErrorProviderfaultAnthropicVertexLlmFailed: "call.in-progress.error-providerfault-anthropic-vertex-llm-failed";
        ...
        readonly CallInProgressErrorProviderfaultTogetherAiLlmFailed: "call.in-progress.error-providerfault-together-ai-llm-failed";
        ...
        readonly CallInProgressErrorProviderfaultAnyscaleLlmFailed: "call.in-progress.error-providerfault-anyscale-llm-failed";
        ...
        readonly CallInProgressErrorProviderfaultOpenrouterLlmFailed: "call.in-progress.error-providerfault-openrouter-llm-failed";
        ...
        readonly CallInProgressErrorProviderfaultPerplexityAiLlmFailed: "call.in-progress.error-providerfault-perplexity-ai-llm-failed";
        ...
        readonly CallInProgressErrorProviderfaultDeepinfraLlmFailed: "call.in-progress.error-providerfault-deepinfra-llm-failed";
        ...
        readonly CallInProgressErrorProviderfaultRunpodLlmFailed: "call.in-progress.error-providerfault-runpod-llm-failed";
        ...
        readonly CallInProgressErrorProviderfaultCustomLlmLlmFailed: "call.in-progress.error-providerfault-custom-llm-llm-failed";
        ...
        readonly PipelineErrorCartesia502ServerError: "pipeline-error-cartesia-502-server-error";
        ...
        readonly PipelineErrorElevenLabsVapiVoiceDisabledByOwner: "pipeline-error-eleven-labs-vapi-voice-disabled-by-owner";
        ...
        readonly PipelineErrorElevenLabs503ServerError: "pipeline-error-eleven-labs-503-server-error";
        ...
        readonly CallInProgressErrorProviderfaultElevenLabs503ServerError: "call.in-progress.error-providerfault-eleven-labs-503-server-error";
        ...
        readonly PipelineErrorDeepgramReturningEconnreset: "pipeline-error-deepgram-returning-econnreset";
        ...
        readonly CallInProgressErrorWarmTransferMaxDuration: "call.in-progress.error-warm-transfer-max-duration";
        readonly CallInProgressErrorWarmTransferAssistantCancelled: "call.in-progress.error-warm-transfer-assistant-cancelled";
        readonly CallInProgressErrorWarmTransferSilenceTimeout: "call.in-progress.error-warm-transfer-silence-timeout";
        readonly CallInProgressErrorWarmTransferMicrophoneTimeout: "call.in-progress.error-warm-transfer-microphone-timeout";
        readonly CallInProgressErrorWarmTransferHangTimeout: "call.in-progress.error-warm-transfer-hang-timeout";
        readonly CallInProgressErrorWarmTransferIdleTimeout: "call.in-progress.error-warm-transfer-idle-timeout";
        ...
        readonly CallInProgressErrorTransferFailed: "call.in-progress.error-transfer-failed";
        readonly CustomerBusy: "customer-busy";
        readonly CustomerEndedCall: "customer-ended-call";
        readonly CustomerEndedCallAfterWarmTransferAttempt: "customer-ended-call-after-warm-transfer-attempt";
        ...
        readonly CallInProgressErrorSipInboundCallFailedToConnect: "call.in-progress.error-sip-inbound-call-failed-to-connect";
        readonly CallInProgressErrorProviderfaultOutboundSip403Forbidden: "call.in-progress.error-providerfault-outbound-sip-403-forbidden";
        readonly CallInProgressErrorProviderfaultOutboundSip407ProxyAuthenticationRequired: "call.in-progress.error-providerfault-outbound-sip-407-proxy-authentication-required";
        readonly CallInProgressErrorProviderfaultOutboundSip503ServiceUnavailable: "call.in-progress.error-providerfault-outbound-sip-503-service-unavailable";
        readonly CallInProgressErrorProviderfaultOutboundSip480TemporarilyUnavailable: "call.in-progress.error-providerfault-outbound-sip-480-temporarily-unavailable";
        readonly CallInProgressErrorSipOutboundCallFailedToConnect: "call.in-progress.error-sip-outbound-call-failed-to-connect";
        ...
        readonly CallEndingHookExecutedSay: "call.ending.hook-executed-say";
        readonly CallEndingHookExecutedTransfer: "call.ending.hook-executed-transfer";
        readonly CallRingingSipInboundCallerHungupBeforeCallConnect: "call.ringing.sip-inbound-caller-hungup-before-call-connect";
        readonly CallRingingErrorSipInboundCallFailedToConnect: "call.ringing.error-sip-inbound-call-failed-to-connect";
     ...
     * This is the destination where the call ended up being transferred to. If the call was not transferred, this will be empty.
     */
    type Destination = Vapi.TransferDestinationNumber | Vapi.TransferDestinationSip;
}
