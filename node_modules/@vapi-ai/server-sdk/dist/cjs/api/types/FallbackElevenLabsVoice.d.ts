...
export declare namespace FallbackElevenLabsVoice {
    /**
     * This is the provider-specific ID that will be used. Ensure the Voice is present in your 11Labs Voice Library.
     */
    type VoiceId = ("burt" | "marissa" | "andrea" | "sarah" | "phillip" | "steve" | "joseph" | "myra" | "paula" | "ryan" | "drew" | "paul" | "mrb" | "matilda" | "mark") | string;
    /**
     * This is the model that will be used. Defaults to 'eleven_turbo_v2' if not specified.
     */
    type Model = "eleven_multilingual_v2" | "eleven_turbo_v2" | "eleven_turbo_v2_5" | "eleven_flash_v2" | "eleven_flash_v2_5" | "eleven_monolingual_v1";
    const Model: {
