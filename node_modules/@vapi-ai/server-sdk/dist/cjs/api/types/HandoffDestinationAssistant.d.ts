...
export declare namespace HandoffDestinationAssistant {
    /**
     * This is the plan for manipulating the message context before handing off the call to the next assistant.
     */
    type ContextEngineeringPlan = Vapi.ContextEngineeringPlanLastNMessages | Vapi.ContextEngineeringPlanNone | Vapi.ContextEngineeringPlanAll;
}
