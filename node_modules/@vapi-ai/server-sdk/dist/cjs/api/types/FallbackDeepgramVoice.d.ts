...
export declare namespace FallbackDeepgramVoice {
    /**
     * This is the provider-specific ID that will be used.
     */
    ...
    const VoiceId: {
        ...
        readonly Nestor: "nestor";
        readonly Sirio: "sirio";
        readonly Carina: "carina";
        readonly Alvaro: "alvaro";
        readonly Diana: "diana";
        readonly Aquila: "aquila";
        readonly Selena: "selena";
        readonly Javier: "javier";
    };
    /**
     * This is the model that will be used. Defaults to 'aura-2' when not specified.
     */
