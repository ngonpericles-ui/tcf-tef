...
export declare namespace SuccessEvaluationPlan {
    /**
     * This enforces the rubric of the evaluation. The output is stored in `call.analysis.successEvaluation`.
     *
     * Options include:
     ...
     * Default is 'PassFail'.
     */
    type Rubric = "NumericScale" | "DescriptiveScale" | "Checklist" | "Matrix" | "PercentageScale" | "LikertScale" | "AutomaticRubric" | "PassFail";
    const Rubric: {
