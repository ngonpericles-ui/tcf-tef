...
const options = {
    definition: {
      ...
      `,
        ...
        servers: [
            {
                url: environment_1.config.nodeEnv === 'production'
                    ? 'https://api.tcftef.com'
                    : `http://localhost:${environment_1.config.port}`,
                description: environment_1.config.nodeEnv === 'production' ? 'Production server' : 'Development server'
            }
        ],
        components: {
            securitySchemes: {
