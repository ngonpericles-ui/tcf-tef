...
router.get('/results/:testId', auth_1.authenticate, (0, validation_1.validateParams)({ testId: validation_1.commonSchemas.id }), testController_1.TestController.getTestResults);
