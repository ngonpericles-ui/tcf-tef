...
exports.testSchemas = {
    create: joi_1.default.object({
        test: joi_1.default.object({
            ...
            image: joi_1.default.string().uri().optional(),
            levels: joi_1.default.array().items(exports.commonSchemas.courseLevel).optional(),
            subscriptions: joi_1.default.array().items(exports.commonSchemas.subscriptionTier).optional()
        }).required(),
        questions: joi_1.default.array().items(joi_1.default.object({
            questionText: joi_1.default.string().min(5).max(1000).required(),
            type: joi_1.default.string().valid('multiple-choice', 'true-false', 'short-answer', 'essay').required(),
            options: joi_1.default.array().items(joi_1.default.string().max(500)).max(10).optional(),
            correctAnswer: joi_1.default.alternatives().try(joi_1.default.number().integer().min(0), joi_1.default.string().max(1000), joi_1.default.boolean()).required(),
            points: joi_1.default.number().integer().min(1).max(10).required(),
            explanation: joi_1.default.string().max(1000).optional(),
