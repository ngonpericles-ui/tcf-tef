...
class HomeService {
    static async getDashboardData(userId) {
        try {
            ...
            const studySession = await this.getStudySessionData(userId);
            const daysOnPlatform = await this.getDaysOnPlatform(userId);
            const regionalTime = await this.getRegionalTimeData(userId);
            return {
                user: {
                    ...user,
