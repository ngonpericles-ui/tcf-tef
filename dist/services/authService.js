    ...
    static async register(data) {
        try {
            ...
            if (existingUser) {
                ...
                throw new errors_1.ConflictError(`User with email ${data.email} already exists`);
            }
    ...
    static async login(data) {
        ...
        try {
            ...
            if (user.status === client_1.UserStatus.INACTIVE) {
                ...
                throw new errors_1.AuthenticationError('Account is inactive. Please contact support.');
            }
