...
exports.FloatingAiAssistantService = void 0;
const logger_1 = require("../utils/logger");
const geminiApiManager_1 = __importDefault(require("../utils/geminiApiManager"));
class FloatingAiAssistantService {
    static async getAssistance(userId, userMessage, context) {
        try {
            const systemPrompt = this.buildSystemPrompt(context);
            const userPrompt = this.buildUserPrompt(userMessage, context);
            const genAI = geminiApiManager_1.default.getClient();
            ...
            logger_1.logger.info('AI Assistant response generated', {
                userId,
                page: context.page,
            ...
            logger_1.logger.error('Error generating AI assistance:', error);
            return {
...
- Targeted preparation by level`;
    ...
    static buildUserPrompt(userMessage, context) {
...
exports.FloatingAiAssistantService = FloatingAiAssistantService;
//# sourceMappingURL=floatingAiAssistantService.js.map